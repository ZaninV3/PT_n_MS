...
$$M[X^{2}] = \int_{-\infty}^{+\infty} x^{2}f(x) \, dx = \int_{0}^{2} 0.5 x^{2} (2 - x)\, dx = 0.5 \int_{0}^{2} (2x^{2} - x^3) dx = 0.5 [\frac{2x^{3}}{3} - \frac{x^{4}}{4}]_{0}^{2} = 0.5((\frac{16}{3} - \frac{16}{4}) - 0) = 0.5 * \frac{4}{3} = \frac{2}{3}$$
